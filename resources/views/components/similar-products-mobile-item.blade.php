...
@endphp
<div class="product-item item relative group/item [scroll-snap-align:center] sm:!w-full">
    <div class="content relative flex flex-col h-full">
        <div class="image-wrapper relative flex w-full shrink-0">
            ...
            @if(!$product->labels->isEmpty())
                <div
                    ...
                    <div style="background-color: {{$product->labels->first()->color}}!important;"
        ...
        <div
            ...
            <div class="product-name-field">
                <a href="{{route('product.detail',$product->slug)}}"
                   class="text text-main-500/65 leading-tight clamp-fs [--minv-fs:16] [--maxv-fs:20] [font-size:--clamp-fs] duration-300 hover:text-main-500 line-clamp-1">
                    {{$collection->name}}
                </a>
            </div>
            <div
