...
@section('content')
    ...
    <main class="main-field block relative overflow-clip pt-[--header-height]">
        ...
        <section class="similar-product-section clamp-1 [--minv-1:30] [--maxv-1:120] pb-[--clamp-1] clamp-2 [--minv-2:15] [--maxv-2:50] pt-[--clamp-2] relative group/sps ">
            <div class="overflow-clip">
                <div
                    ...
                    <div class="wrapper">
                        ...
                        <div class="product-list-wrapper clamp-1 [--minv-1:20] [--maxv-1:72] mt-[--clamp-1] group/plw fx-product-list"
                            data-fx-reveal="scroll y 10% 0.45">
                            <x-similar-products :products="$product->relatedProducts"></x-similar-products>
                            <div class="mobile-view hidden md:block overflow-visible relative scrollable-wrapper">
                                <x-similar-products-mobile :products="$product->relatedProducts"></x-similar-products-mobile>
                            </div>
                        </div>
                    </div>
                </div>
